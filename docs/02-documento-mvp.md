...
- [ ] **CA6.3** — Cada ação sugerida é específica e executável (ex.: *"Revisar o texto do passo 3 do cadastro — 340 tickets citam confusão nesse ponto"*), nunca genérica.
...
- [ ] **CA7.4** — Existe painel interno mostrando a taxa de aprovação dos temas por cliente — métrica de acompanhamento do risco **R01**.
...
**Leitura:** F5, F4, F7 e F2 são alto valor e baixo esforço — executados primeiro. F3 é alto valor
e alto esforço, mas é **o núcleo do produto**, então é iniciado em paralelo desde a semana 1 por
carregar o maior risco. F9, F10 e F11 são baixo valor relativo e alto esforço — adiados sem
hesitação.
